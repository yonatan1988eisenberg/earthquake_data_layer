...
_releaser:
	...
	docker tag  ${DOCKERHUB_USERNAME}/${APPLICATION_NAME}:${_BUILD_ARGS_TAG} ${DOCKER_USER_NAME}/${APPLICATION_NAME}:latest
	docker tag  ${DOCKERHUB_USERNAME}/${APPLICATION_NAME}:${_BUILD_ARGS_TAG} ${DOCKER_USER_NAME}/${APPLICATION_NAME}:${VERSION}
